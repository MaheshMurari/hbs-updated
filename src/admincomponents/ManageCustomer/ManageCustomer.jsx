...
const ManageCustomers = () => {
 ...
 const handleUpdateCustomer = async () => {
  ...
  const filteredCustomers = customers.filter(customer => 
    ...
    (!customerStatusFilter || customer.status === customerStatusFilter)
  );
        ...
        {loading ? (
          ...
          <>
            ...
            />
             ...
             <select value={customerStatusFilter} onChange={(e) => setcustomerStatusFilter(e.target.value)} className="dropdown">
            ...
            {selectedCustomer && (
              <div className="customer-details">
                <h2 className='sub-heading'>CUSTOMER DETAILS</h2>
